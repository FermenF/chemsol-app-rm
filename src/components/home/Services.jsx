                    ...
                    <div className="row g-5">
                        <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                            <div className="section-title position-relative mb-4 pb-2">
                                <h6 className="position-relative text-primary ps-4">lorem fadeInUp </h6>
                                <h2 className="mt-2">Tempor erat elitr rebum at clita. Diam dolor diam</h2>
                            </div>
                            ...
                            <div className="row g-3">
                                <div className="col-sm-6">
                                    <h6 className="mb-3">
                                        <i className="fa fa-check text-primary me-2"></i>lorem fadeInUp</h6>
                                    <h6 className="mb-0">
                                        <i className="fa fa-check text-primary me-2"></i>lorem fadeInUp</h6>
                                </div>
                                <div className="col-sm-6">
